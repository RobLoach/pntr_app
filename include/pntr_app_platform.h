...
// Platform detection.
#if !defined(PNTR_APP_CLI) && !defined(PNTR_APP_WEB) && !defined(PNTR_APP_LIBRETRO) && !defined(PNTR_APP_RAYLIB) && !defined(PNTR_APP_SDL) && !defined(PNTR_APP_RSGL)
    // libretro
